...
if __name__ == '__main__':
    ...
    for i, path in enumerate(args.files):
        with (open(f'{path}.tsv') as train_manifest, open(f'{path}.wrd') as train_words, open(f'{path}.ltr') as train_letters):
    ...
    with open(os.path.join(args.output_dir, 'dict.ltr.txt'), 'w') as dict_output: 
